...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_FUNCTION_48] = LAYOUT_ortho_4x12(
            ...
            _______ , KC_F5   , KC_F6   , KC_F7   , KC_F8   , KC_NO   ,         , KC_MSTP , KC_VOLD ,                , KC_NO          , _______       ,
...
layer_state_t default_layer_state_set_user(layer_state_t state) {
    rgblight_set_layer_state(0, layer_state_cmp(state, _DVORAK_48));
    rgblight_set_layer_state(1, layer_state_cmp(state, _MAYA_48));
    rgblight_set_layer_state(2, layer_state_cmp(state, _QWERTY_48));

    return state;
}

layer_state_t layer_state_set_user(layer_state_t state) {
    rgblight_set_layer_state(4, layer_state_cmp(state, _NUMBERS_48));
    rgblight_set_layer_state(5, layer_state_cmp(state, _MOUSE_48));
    rgblight_set_layer_state(6, layer_state_cmp(state, _FUNCTION_48));
