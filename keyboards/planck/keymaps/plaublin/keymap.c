...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_SYMBOLS] = LAYOUT_ortho_4x12(
       ...
       _______, KC_NO,KC_NO,KC_NO,KC_TAB,TT(_MOUSE),KC_NO,KC_LBRC,KC_RBRC,KC_BSLS,KC_NO                            , _______,
    ...
    [_FUNCTION] = LAYOUT_ortho_4x12(
       _______, KC_DEL , KC_F1  , KC_F2  , KC_F3  , KC_F4  , KC_MPLY, KC_VOLU , DF(_FOCAL), DF(_QWERTY)  , KC_NO    , _______,
