...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    //|--------+---------+------------+--------------+---------------+---------+---------+------------+--------------+-----------+---------+--------------|
       _______ , KC_CIRC , KC_EXLM    , KC_AT        , KC_HASH       , KC_LPRN , KC_RPRN , KC_UNDS    , KC_PERC      , KC_NO     , KC_DLR  , _______      ,
    //|--------+---------+------------+--------------+---------------+---------+---------+------------+--------------+-----------+---------+--------------|
       _______ , KC_NO   , KC_NO      , KC_NO        , KC_NO         , KC_SLSH , KC_BSLS , KC_MINS    , KC_AMPR      , KC_NO     , KC_EQL  , KC_UP        ,
    //|--------+---------+------------+--------------+---------------+---------+---------+------------+--------------+-----------+---------+--------------|
